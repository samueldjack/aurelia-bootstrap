...
System.register(["aurelia-pal", "aurelia-framework", "../utils/bootstrap-options", "velocity-animate", "./aubs-accordion"], function (_export, _context) {
    "use strict";

    var PLATFORM, inject, bindable, bindingMode, containerless, useView, bootstrapOptions, velocity, AubsAccordionCustomElement, _dec, _dec2, _dec3, _class, _desc, _value, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, AubsAccordionGroupCustomElement;
    ...
    return {
        ...
        execute: function () {
            _export("AubsAccordionGroupCustomElement", AubsAccordionGroupCustomElement = (_dec = inject(AubsAccordionCustomElement), _dec2 = useView(PLATFORM.moduleName('./aubs-accordion-group.html')), _dec3 = bindable({ defaultBindingMode: bindingMode.twoWay }), containerless(_class = _dec(_class = _dec2(_class = (_class2 = function () {
